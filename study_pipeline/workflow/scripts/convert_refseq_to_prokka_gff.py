...
def main():
    ...
    https://github.com/gtonkinhill/panaroo/blob/master/scripts/convert_refseq_to_prokka_gff.py
    It is an auxiliary script from the panaroo github repo to convert refseq gffs to prokka formatted ones
    """
